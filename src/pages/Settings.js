  ...
  <div className="container">
    <div className="row">
      <div className="col-12 my-5 mx-auto">
        <img className="d-flex justify-content-center mx-auto" id="Logo" src="https://i.imgur.com/MNXViWI.png" alt="logo"></img>
      </div>
    </div>
    <div className="row">
      <div className="container">
        <div id="custom-form" className="col-9 mb-5 offset-3 mx-auto">
          ...
          <form>
            <div className="form-group">
              ...
              <h5 id="label-color" className="form-text">Delete your GamersOnly account</h5>
            </div>
          </form>
        </div>
      </div>
